...
(function() {
  ...
  const CURRENCY_RATES = {
    ...
    USD: { rate: 0.0306, symbol: '$', code: 'USD', decimals: 0 },
    EUR: { rate: 0.0266, symbol: '€', code: 'EUR', decimals: 0 },
    GBP: { rate: 0.023, symbol: '£', code: 'GBP', decimals: 0 },
    JPY: { rate: 4.86, symbol: '¥', code: 'JPY', decimals: 0 },
    CNY: { rate: 0.211, symbol: '¥', code: 'CNY', decimals: 0 },
    KRW: { rate: 45.85, symbol: '₩', code: 'KRW', decimals: 0 },
    TWD: { rate: 0.977, symbol: '$', code: 'TWD', decimals: 0 },
    HKD: { rate: 0.239, symbol: '$', code: 'HKD', decimals: 0 },
    SGD: { rate: 0.0392, symbol: '$', code: 'SGD', decimals: 0 },
    MYR: { rate: 0.12, symbol: 'RM', code: 'MYR', decimals: 0 },
    PHP: { rate: 1.84, symbol: '₱', code: 'PHP', decimals: 0 },
    IDR: { rate: 521, symbol: 'Rp', code: 'IDR', decimals: 0 },
    VND: { rate: 803, symbol: '₫', code: 'VND', decimals: 0 },
    INR: { rate: 2.84, symbol: '₹', code: 'INR', decimals: 0 },
    RUB: { rate: 2.56, symbol: '₽', code: 'RUB', decimals: 0 },
